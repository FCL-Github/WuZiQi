...
var Player = /** @class */ (function () {
    ...
    Player.prototype.judgeWinner = function (index, chessDic) {
        var row = index / 15 + 1;
        var column = index % 15 + 1;
        //横纵向判断连子
    ...
    //横向连子判断
    Player.prototype.checkHorizontalChess = function (column, index, chessDic) {
        var chessColor = chessDic[index];
        var i = 1;
        var j = 1;
        //横向减,算i-1的连子数
        for (; i < 6;) {
    ...
    //纵向连子判断
    Player.prototype.checkVerticalChess = function (row, index, chessDic) {
        var chessColor = chessDic[index];
        var i = 1;
        var j = 1;
        //纵向减
    ...
    //135°方向连子判断
    Player.prototype.checkLeftUpToRightDownChess = function (row, column, index, chessDic) {
        var chessColor = chessDic[index];
        var i = 1;
        var j = 1;
        //做减
    ...
    //45°方向连子判断
    Player.prototype.checkLeftDownToRightUpChess = function (row, column, index, chessDic) {
        var chessColor = chessDic[index];
        var i = 1;
        var j = 1;
        //做减
